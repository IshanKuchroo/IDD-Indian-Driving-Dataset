...
def train_and_test(train_ds, test_ds, valid_ds, list_of_metrics, list_of_agg, save_on, pretrained=False):
...
if __name__ == '__main__':
    ...
    list_of_metrics = ['acc', 'hlm', 'f1_weighted']
    list_of_agg = ['sum']

    train_and_test(train_ds, test_ds, valid_ds, list_of_metrics, list_of_agg, save_on='acc', pretrained=True)
